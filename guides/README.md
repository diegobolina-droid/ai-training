...
Personalized learning paths based on your background and goals.
- For traditional software engineers
- For ML engineers transitioning to LLMs
- For product engineers
- For technical leaders

### 🛠️ **[Tools Ecosystem](./tools-ecosystem.md)**
Comprehensive guide to AI coding tools and when to use them.
- Cursor IDE
- Claude Code
- GitHub Copilot
...
**Navigation:** [← Back to Main](../README.md) | [View Curriculum →](../curriculum/)
